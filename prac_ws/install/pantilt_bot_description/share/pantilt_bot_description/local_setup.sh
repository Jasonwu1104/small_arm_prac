...
: ${AMENT_CURRENT_PREFIX:="/work/prac_ws/install/pantilt_bot_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pantilt_bot_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pantilt_bot_description/environment/path.sh"
